	...
	<div class="row">
		...
		<nav>
			<div class="nav-wrapper">
				<div class="col s12">
					<a href="${contextRoot}/home">Home</a><a
						href="${contextRoot}/show/all/products">Products</a><a
						href="${contextRoot}/show/category/${product.getCategoryId()}/products">${categoryName}</a>
					<%-- <a class="active">Show</a> <a class="active">${title}</a> --%>
				</div>
			</div>
		</nav>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-4">
			...
			<a href="#" class="thumbnail" data-toggle="popover"
				data-full="${contextRoot}/resources/images/${product.getCode()}.png">
		...
		<div class="col-xs-12 col-sm-8">
			...
			<strong>SelectSize :</strong><a class="btn btn-info" ${XS}><small>XS</small></a>
